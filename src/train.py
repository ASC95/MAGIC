...
def main():
    ...
    for app_name in target_names:
        ...
        if should_evaluate:
            ...
            #   - Internally we always ask for 20,000 samples, but filter down to at most <sample size> (e.g. 500)
    ...
    if should_evaluate:
        ...
        if not df_results.empty:
            ...
            print(df_results)
            # Save to PNG
            visualize.save_metrics_table_png(df_results, 'evaluation_summary.png', 1800)
